module.exports = {
    ...
    clientLibRoot: "./../ui.apps/src/main/content/jcr_root/apps/learnings/clientlibs",

    libs: [
        {
            name: "clientlib-dependencies",
            allowProxy: true,
            categories: ["learnings.dependencies"],
        ...
        },
        {
            name: "clientlib-site",
            allowProxy: true,
            categories: ["learnings.site"],
            dependencies: ["learnings.dependencies"],
            serializationFormat: "xml",
            cssProcessor : ["default:none", "min:none"],
            jsProcessor: ["default:none", "min:none"],
            assets: {
